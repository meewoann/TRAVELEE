...
username_label = tk.Label(top_frame,
                          text="Enter username:",
                          font=FONT,
                          bg=DARK_GREY,
                          fg=WHITE)
...
message_textbox = tk.Entry(bottom_frame,
                           ...
                           fg=WHITE,
                           width=38)
message_textbox.pack(side=tk.LEFT,
                     padx=10)
...
def run_menu():
    root.destroy() # Tắt cửa sổ intro
    root.after(3000,subprocess.call([sys.executable, 'C:\\Users\\ADMIN\\OneDrive\\Desktop\\tkinter\\build\\gui_menu.py']))

return_button = tk.Button(middle_frame,
                            text="Back",
                            font=BUTTON_FONT,
                            bg=OCEAN_BLUE,
                            fg=WHITE,
...
return_button.place(x=300, y=520)
'Send'
